...
///
package org.mifos.tools.mfg.service.pebble.core;
...
@UtilityClass
public class PebbleTemplateServiceConstants {
    public static final String MIFOS_TOOLS_MFG_SERVICE_PEBBLE_PACKAGE_BASE =
    ...
    public static final String MIFOS_TOOLS_MFG_SERVICE_PEBBLE_STARTER_PACKAGE =
            MIFOS_TOOLS_MFG_SERVICE_PEBBLE_PACKAGE_BASE + ".starter";
}
